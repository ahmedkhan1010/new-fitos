  ...
  r_too_hard: {
    resolution: {
      ...
      body: [
        ...
        "If every exercise feels too hard (not just one), your Fitness Level in Profile may be set higher than where you currently are — update it and regenerate your plan for an easier starting point.",
        "If it's just one or two specific lifts, that's normal — everyone has individual strengths and weaknesses. Drop the weight 10-20% on just those.",
      ],
      cta: { label: 'Update Fitness Level in Profile', href: 'profile.html' },
